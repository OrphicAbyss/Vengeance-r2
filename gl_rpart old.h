...
//types of particles
typedef enum {
	p_sparks, p_smoke, p_fire, p_blood, p_chunks, p_lightning, p_bubble, p_trail, p_custom
} part_type_t;

//custom movement effects
typedef enum {
	pm_static, pm_normal, pm_float, pm_bounce, pm_bounce_fast, pm_shrink, pm_die, pm_grow, pm_nophysics
} part_move_t;
