...
void List_Maps_f (void) 
{ 
	Cbuf_AddText ("dir maps");
} 

void List_Skies_f (void) 
{
	Cbuf_AddText ("dir gfx/env");
}

extern void Cvar_List_f(void);
extern void Cvar_Set_f (void);
extern void Cvar_SetA_f (void);
extern void COM_Dir_f (void);
/*
============
Cmd_Init
============
...
//
	...
	Cmd_AddCommand ("listmaps", List_Maps_f);
	Cmd_AddCommand ("listskies", List_Skies_f);
...
// fail if the command already exists
	...
	if (host_initialized)	//dont fill the hunk after initialisation
