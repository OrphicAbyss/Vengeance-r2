...
#define	VERTEXSIZE	(3+2+2+2+3) //old 7
//#define		VERTEXSIZE 16 // :o
...
typedef struct glpoly_s
{
	...
	// TODO: replace with per-vertex smooth normals
...
typedef struct msurface_shader_light_cache_s
{
	byte mask[ (R_MAX_SHADER_LIGHTS + 7) / 8 ];
}
msurface_shader_light_cache_t;
...
// lighting info
	...
	// shader light stuff
	msurface_shader_light_cache_t shaderLights;
...
// common with node
	...
	// attempted auto water trans fix - Entar
...
#define R_ALIAS_SHELL			2
#define R_ALIAS_OUTLINE			4
#define R_ALIAS_ADDITIVE		16
...
#define	MAXALIASVERTS	8192 //qmb :polycount x8 1024
...
typedef struct model_s
{
	...
	// attempted water trans fix - Entar
	int			vissize;
...
//
	...
	qboolean   watertrans; // mh - auto water trans
